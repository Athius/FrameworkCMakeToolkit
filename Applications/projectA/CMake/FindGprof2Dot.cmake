if (UNIX)
    if ("${GPROF2DOT_FILE}" STREQUAL "") 
        find_file(GPROF2DOT_FILE gprof2dot.py HINTS ${GPROF2DOT_FILE} DOC "gprof2dot.py file to convert gprof file to dot graph")
        ...
        if (NOT GPROF2DOF_FILE)
            ...
            unset(GPROF2DOT_FILE CACHE)
            set(GPROF2DOT_FILE "${GPROF2DOF_THIRD}" CACHE DOC "gprof2dot.py file to convert gprof file to dot graph")
        endif()
