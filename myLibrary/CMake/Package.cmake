...
macro(try_build_package)
    ...
    set(CPACK_PACKAGE_VERSION_MAJOR "${${PROJECT_OUTPUT_NAME}_VERSION_MAJOR}")
    set(CPACK_PACKAGE_VERSION_MINOR "${${PROJECT_OUTPUT_NAME}_VERSION_MINOR}")
    set(CPACK_PACKAGE_VERSION_PATCH "${${PROJECT_OUTPUT_NAME}_VERSION_PATCH}")
